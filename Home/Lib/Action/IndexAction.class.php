...
class IndexAction extends CommonAction {
    ...
    public function getDate(){
        ...
        $subtables = $utbs->field('utbs.id as tid,subtbs.name,stbcols.subtbcolname,stbcols.calculation,stbcols.unit')->join(array('LEFT JOIN subtbs ON utbs.id = subtbs.tid','LEFT JOIN stbcols ON stbcols.stid = subtbs.id'))->where('utbs.id='.$_SESSION['utb'][id])->select();
